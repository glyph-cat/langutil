...
function appendDictionary(dict, identifier) {
  ...
  if (identifier) {
    ...
    printWarning('No identifier provided - Everytime the same scope of code is executed, the same contents are being appended to the dictionary. Although this is done by merging/overwriting and should not cause any memory issues, we still encourage you to add an identifier.\n\nIf you need appendDictionary to be called repeatedly for the same scope, disregard this message as it will not appear in production mode. ');
